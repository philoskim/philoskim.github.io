...
이 글들은 클로저(Clojure) 프로그래밍 언어를 공부하면서 가졌던 의문점들을 해결해 나간
과정을 정리한 것이다. 대부분의 내용들은 클로저 관련 서적들에도 자세한 설명이 없는
것들이다. 인터넷을 검색해 모은 가능한 한 객관적인 자료를 바탕으로 내린 결론들이지만,
경우에 따라서는 제 개인의 주관적인 판단이 개입된 부정확한 분석 내용이 포함되어 있을 수
있음을 미리 밝힌다. 물론 그런 부분은 개인적으로 내린 추론임을 명시적으로 밝힐 것이다.

아울러 이 글들은 클로저의 기본 내용을 알고 있다는 전제 아래 쓰여져서, 클로저 초보자들이
이해하기에는 어려움이 있을 수 있지만, 클로저를 깊이 있게 이해하고자 하는 사람들에게는 많은
도움이 될 것으로 믿는다.
