...
(s/explain ::person
  {::first-name "Elon"})
; >> val: #:spec-guide.intro{:first-name "Elon"} fails
;    spec: :spec-guide.intro/person
;    predicate: (contains? % :spec-guide.intro/last-name)
;
;    val: #:spec-guide.intro{:first-name "Elon"} fails
;    spec: :spec-guide.intro/person
;    predicate: (contains? % :spec-guide.intro/email)

(s/explain ::person
  {::first-name "Elon"
   ::last-name "Musk"
   ::email "n/a"})
; >> In: [:spec-guide.intro/email]
;    val: "n/a" fails
;    spec: :spec-guide.intro/email-type
;    at: [:spec-guide.intro/email]
...
; => #spec_guide.intro.Person{:first-name "Elon", :last-name "Musk",
...
; => #:spec-guide.intro{:id :s1, :host "example.com", :port 5555}
...
; (ranged-rand 10 5)
; >> Call to #'spec-guide.intro/ranged-rand did not conform to spec:
...
;                               :line 400,
;                               :var-scope spec-guide.intro/eval13655}
...
;                                    :num-tests 1000,
;                                    :seed 1477538561577},
;                                    :sym spec-guide.intro/ranged-rand})
...
(stest/instrument `snake-case)

(snake-case :clojure-spec)
; => "clojure_spec"

; (snake-case "clojure-spec")
; >> Unhandled clojure.lang.ExceptionInfo
;    Call to #'spec-guide.intro/snake-case did not conform to spec:
;    In: [0]
;    val: "clojure-spec" fails
;    at: [:args :kw]
;    predicate: keyword?
