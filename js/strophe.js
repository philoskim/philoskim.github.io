...
Strophe.Websocket.prototype = {
   ...
   /// begin of my code
   _reLowerCaseTagNames: /<\/??[A-Z]+?[ >]/g,

   _toLowerCaseTagNames: function (stanza) {
       return stanza.replace(this._reLowerCaseTagNames,
        ...
        if (data.length > 0 && !this._conn.paused) {
            for (var i = 0; i < data.length; i++) {
                if (data[i] !== null) {
                    ...
                    /// begin of my code
                    // this.socket.send(rawStanza);  // original code
                    this.socket.send(this._toLowerCaseTagNames(rawStanza));
                    /// end of my code
                }
            }
            this._conn._data = [];
